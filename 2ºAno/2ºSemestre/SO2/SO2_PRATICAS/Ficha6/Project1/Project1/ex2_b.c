...
int _tmain(int argc, TCHAR* argv[])
{
    ...
    //cria semaforo (o semaforo tem 2 slots e 2 começam disponiveis)
    hSem = CreateSemaphore(NULL, 2, 2, TEXT("SO2_SEM"));
    ...
    //vamos esperar por um slot
    _tprintf(TEXT("A aguardar por um slot ....\n"));
    WaitForSingleObject(hSem, INFINITE);

    _tprintf(TEXT("Chat iniciado ....\n"));
    ...
    //libertamos o nosso slot e damos a vez a outro que esteja à espera
