...
to go
  ...
  if ([xcor] of turtle 0 = xend) and ([ycor] of turtle 0 = yend) and
             ((Objetivo? and count patches with [pcolor = green] = 0)  or not Objetivo?)
    [
        stop
    ]
    eat-trail
    ifelse tipoMovimento = "Básico" or tipoMovimento = "Probabilistico"
      [move-turtle]
      [ifelse tipoMovimento = "Maior Alcance"
      [move-maior-alcance] ; move-maior-alcance
      [] ; move-memoria
]
end
...
to-report trilho-frente [distancia]
    ...
    ifelse ([pcolor] of patch-ahead distancia = green) or ([pcolor] of patch-ahead distancia = red and
             ((Objetivo? and count patches with [pcolor = green] = 0)  or not Objetivo?))
    [
        report 1
    ]
    ...
    [
        ...
        [
            ...
            [
                ...
                [
                    right 90
                    if tipoMovimento = "Probabilistico"
...
tipoMovimento
tipoMovimento
"Básico" "Probabilistico" "Maior Alcance" "Memória!"
1
