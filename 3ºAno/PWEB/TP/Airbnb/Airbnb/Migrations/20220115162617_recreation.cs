        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Accomodations_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AccomodationImageId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccomodationImages", x => x.AccomodationImageId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AccomodationRatingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccomodationRatings", x => x.AccomodationRatingId);
                    table.ForeignKey(
                        name: "FK_AccomodationRatings_Accomodations_AccomodationId",
                        column: x => x.AccomodationId,
                        principalTable: "Accomodations",
                        principalColumn: "AccomodationId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccomodationRatings_Customers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookingUntil = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccomodationRatings_AccomodationId",
                table: "AccomodationRatings",
                column: "AccomodationId");

            migrationBuilder.CreateIndex(
                name: "IX_AccomodationRatings_CustomerId",
                table: "AccomodationRatings",
                column: "CustomerId");
